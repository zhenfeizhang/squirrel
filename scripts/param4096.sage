...
# unit cost for arbitrary ring multiplication
c1 = 14.3 * 10^-6
...
# q_hvc = search_q(beta_agg*8, n)
# q_hvc = search_q(beta_agg*16, n)
# logq_hvc = 17
# q_hvc = search_q(beta_agg*8, n)
q_hvc = 61441
logq_hvc = 16
...
# def print_signing_cost(tau, gamma, n, logq_hvc, c1):
#     online_signing = gamma * c1
#     offline_amortized = 4 * logq * c1
#     offline_worst = 2^(tau +1) *logq * c1
#
#     print("online signing:", online_signing * 10^3, "ms")
#     print("amortized offline signing:", offline_amortized * 10^3, "ms")
#     print("worst-case online signing:", offline_worst/60, "min")
#
# def print_signing_with_cache_cost(tau, n, logq, c1, h):
#     space = ring_elem_size(n, logq) * 2^(h+1)
#     time = 2^(tau - h + 3) * logq * c1
#     print()
#     print("store top", h, "levels")
#     print("space:", space/8/1024/1024, "MB")
#     print("time:", time, "second")
#
# def print_key_gen_time(tau, gamma, logq, c1):
#     time = 2^(tau + 1) * (gamma + 2* logq) * c1
#     print("key gen:", time, "second")
#
# def print_aggregation_time(tau, rho, logq, c1, c2):
#     time = rho * c1 + rho * 2 * (tau + 1) * logq * c2
#     print("aggregation:", time, "second")
#
# def print_verification_time(tau, gamma, logq, rho, c1):
#     time = (2 * logq * tau + 2 * gamma + rho) * c1
#     print("verification:", time * 10^3, "ms")
